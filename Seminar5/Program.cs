...
void ShowArray(int[] array) // метод, который выводит массив
{
    ...
    for(int i = 0; i < array.Length; i++) // до тех пор пока "for" (i=0 - первое число массива = индекс 0;
                                          // пока индекс меньше длинны массива; добавялем +1 шаг)
    {
...
void Print(int[] myArray) // метод, который выводит массив
{
    ...
    for(int i = 0; i < myArray.Length; i++) // до тех пор пока "for" (i=0 - первое число массива = индекс 0; 
                                            // пока индекс меньше длинны массива; добавялем +1 шаг)
    {
...
Console.WriteLine("Число присутствует - " + IsElementHere(myArray, 5)); // в вызове метода указываем наш 
                                                                        // заданный массив myArray и необходимое число.
